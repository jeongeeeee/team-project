...
<div class="container">
	...
	<!-- 
	<div id="store_div_accordion">
			<input type="checkbox" id="answer01">
			<label for="answer01">종류</label>
			<div>
...
<div class="mom_div">
	<div class="float-container">
		<a href="loginPage.do"><img alt="로고" src="resources/image/logo.png" id="logoImg"></a>
		<ul class="float-Management-ul">
			<li><a id="Management" href="javascript:orderHistory();">주문내역관리</a></li>
			<li><a id="Management" href="javascript:salesManagement();">매출정보</a></li>
			<li>
				<div id="store_div_accordion">
					<input type="checkbox" id="answer01">
					<label for="answer01">매장관리</label>
					<div>
						<a href="javascript:productManagement();">제품관리</a>
						<a href="javascript:reviewManagement();">리뷰관리</a>
					</div>
				</div>
				<!-- <a id="Management" href="javascript:storeManagement();">매장관리</a> -->
			</li>
			<li><a id="Management" href="javascript:memberManagement();">회원관리</a></li>
			<li><a id="Management" href="javascript:questionManagement();">Q&A관리</a></li>
			<li><a id="Management" class="announcement" href="javascript:announcement();">공지사항 등록</a></li>
		</ul>
	</div>
</div>
<div class="child_div">	
...
<link href="resources/adminCss/admin.css" rel="stylesheet"/>
